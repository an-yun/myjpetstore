...
public class OrderDAOImpl implements OrderDAO {
    ...
    public void insertOrder(Order order) {
        try{
            ...
            pStatement.setDate(3, get_sql_date(order.getOrderDate()));
    ...
    public void insertOrderStatus(Order order) {
        try{
            Connection connection = new DBUtil().getConnection();
            PreparedStatement pStatement = connection.prepareStatement(INSERT_ORDERSTATUS);
            pStatement.setInt(1, order.getOrderId());
            ...
            if(pStatement.executeUpdate() != 1)
            {
                throw new Exception("insert orderstatus failed!");
            }
            DBUtil.closePreparedStatement(pStatement);
            DBUtil.closeConnection(connection);
        }
    ...
    public java.sql.Date get_sql_date(java.util.Date utilDate)
    {
